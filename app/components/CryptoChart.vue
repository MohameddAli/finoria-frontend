...
const chartDataSets = {
  daily: { labels: ['00:00', '04:00', '08:00', '12:00', '16:00', '20:00', '24:00'], data: [45200, 46800, 45900, 47200, 48100, 47800, 47832], trend: 5.8 },
  weekly: { labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], data: [44500, 45200, 46100, 47200, 46800, 47500, 47832], trend: 7.5 },
  monthly: { labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], data: [38000, 39500, 41200, 43800, 45200, 44800, 46200, 47100, 46800, 47500, 47200, 47832], trend: 12.5 },
  yearly: { labels: ['2020', '2021', '2022', '2023', '2024'], data: [28000, 35000, 42000, 45000, 47832], trend: 70.8 }
}

const chartHeight = computed(() => props.height)
const trendColor = computed(() => trendPercentage.value >= 0 ? 'success' : 'error')
const trendIcon = computed(() => trendPercentage.value >= 0 ? 'mdi-trending-up' : 'mdi-trending-down')
const chartLegends = computed(() => [{ label: 'Portfolio Value', color: '#1976D2' }, { label: 'Trend Line', color: '#4CAF50' }])
...
const getPeriodDescription = (): string => {
  const descriptions = { daily: 'Last 24 hours performance', weekly: 'Last 7 days performance', monthly: 'Last 12 months performance', yearly: 'Last 5 years performance' }
...
const updateChart = () => {
  trendPercentage.value = chartDataSets[selectedPeriod.value as keyof typeof chartDataSets].trend
