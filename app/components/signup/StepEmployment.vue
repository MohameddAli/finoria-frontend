<template>
  <v-form ref="formRef" @submit.prevent="handleNext">
    <v-row>
      <v-col cols="12">
        <h3 class="text-h6 mb-4">{{ t('signup.step3.nationalityTitle') }}</h3>
      </v-col>
      ...
      <v-col cols="12">
        ...
        <h3 class="text-h6 mb-4">{{ t('signup.step3.employmentTitle') }}</h3>
      </v-col>
...
import NationalitySelector from '~/components/form/NationalitySelector.vue';
